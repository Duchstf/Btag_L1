...
entity btag_nn_linear_ap_fixed_16_6_5_3_0_ap_fixed_16_6_0_0_0_linear_config10_s is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of btag_nn_linear_ap_fixed_16_6_5_3_0_ap_fixed_16_6_0_0_0_linear_config10_s is 
...
begin
    ...
    ap_return_17_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, p_read18, ap_return_17_preg)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            ap_return_17 <= p_read18;
        else 
    ...
    ap_return_18_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, p_read19, ap_return_18_preg)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            ap_return_18 <= p_read19;
        else 
