...
set name myproject_mul_8s_8ns_15_1_1
if {${::AESL::PGuard_rtl_comp_handler}} {
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler myproject_dense_resource_ap_fixed_9_4_0_0_0_ap_fixed_16_6_5_3_0_config9_s_w9_V_ROM_AUTObkb BINDTYPE {storage} TYPE {rom} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
