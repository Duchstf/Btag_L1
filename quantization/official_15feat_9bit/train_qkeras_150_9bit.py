...
model.fit(X, y, epochs=100, batch_size=len(X[0]), verbose=2, sample_weight=np.asarray(
    weights), validation_split=0.20, callbacks=[callback])

# Save model
model.save('models/QModel_9bit_150.h5')
